function experiment1(f)
%%%%%%% global thresholding of experiment 3 
f=double(f);
f=f+15;
...
%thr1c=27.9297;
 n=[1 2 3 4];p=[thr1c thr1c thr1c thr1c];
...
figure,imshow(uint8(f)); % title('original image');axis square;
figure,imshow(uint8(f1)); % title('nosied image');axis square;

dnc1=wthresfunc1(c,s,'hard',thr1c); 
dnf1=waverec2(dnc1,s,'coif4');
figure,imshow(dnf1,[]); % title(' denoised image with global');axis square;
